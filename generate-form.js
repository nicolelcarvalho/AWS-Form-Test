...
const awsAccessKeyId = 'AKIAI6SCOHX6OMNAYUYA';
const awsSecretAccessKey = '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';
const bucketName = 'pairings-aws-bucket';
...
fs.readFile('public/index.template.html', 'utf8', (err, input) => {
  ...
  fs.writeFile('public/index.html', data, 'utf8', (e) => {
    if (e) {
      console.log(e);
    }
  });
